...
import { ShoppingCart, Search, Plus, Edit, Trash2, Calendar, MapPin, Package2, Filter } from 'lucide-react'
...
export default function PedidosPage() {
  ...
  const [orderItems, setOrderItems] = useState<OrderItem[]>([{ produtoId: '', quantidade: 1, precoUnitario: 0 }])
  ...
  const loadData = async () => {
    try {
      ...
      // Simular dados para clientes
      const customersData = [
        { id: '1', nome: 'Maria Silva', email: 'maria@email.com' },
        { id: '2', nome: 'João Santos', telefone: '(11) 99999-9999' }
      ]
